...
using System;
using UnityEngine;
//using TargetAttributes = UnityEditor.BuildTargetDiscovery.TargetAttributes;   // inaccessible

namespace UnityEditor
{
    internal class MB_TexArrayStandardShaderGUI : ShaderGUI
    {
        ...
        void DoNormalArea()
        {
            ...
            /*
            // BuildTargetDiscovery is an inaccessible internal class.
        ...
        static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
        {
            ...
            // We need to know if an occlusion map is assigned or not.
            SetKeyword(material, "_HAS_OCCLUSION_MAP", material.GetTexture("_OcclusionMap"));
